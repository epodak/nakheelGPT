...
st.header("NakheelGPT Demo")
st.caption("Next-Gen ChatBot built on top of the state of the art AI model - ChatGPT.")

with st.expander("Upload a document you would like to chat about! 🚀"):
    uploaded_file = st.file_uploader("Uploader",type=None, accept_multiple_files=False, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, label_visibility="hidden")
